    ...
    <div className="min-h-screen bg-app-bg">
      <div className="mx-auto max-w-md">
        ...
        <header className="sticky top-0 z-40 flex items-center justify-between border-b border-gray-100 bg-white px-4 py-3">
          ...
          <h1 className="text-base font-bold text-gray-900">Poll Results</h1>
          <button
            type="button"
            onClick={share}
            className="flex h-8 w-8 items-center justify-center rounded-full hover:bg-gray-100"
        ...
        <div className="px-4 py-4 pb-24 space-y-5">
          ...
          {poll.type === 'standard' && winnerOption && poll.totalVotes > 0 && (
            <div className="rounded-2xl bg-primary-500 p-5 text-white relative overflow-hidden">
          ...
          {poll.type === 'standard' && poll.options && poll.options.length > 0 && (
            <div>
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-base font-bold text-gray-900">Voting Distribution</h3>
              </div>
          ...
          {poll.type === 'location' && poll.locations && (
            <div>
              <h3 className="text-base font-bold text-gray-900 mb-3">Voting Distribution</h3>
              <div className="space-y-2">
                {[...poll.locations]
                  .sort((a, b) => b.votes - a.votes)
                  .map((loc, idx) => (
          ...
          {poll.type === 'schedule' && poll.timeSlots && (
            <div>
              <h3 className="text-base font-bold text-gray-900 mb-3">Availability Overview</h3>

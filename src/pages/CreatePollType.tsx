...
import { BarChart2, Calendar, MapPin, Sliders, GripVertical, ChevronRight, Target, ImageIcon } from 'lucide-react'
...
const pollTypes = [
  ...
  },
  {
    ...
    icon: ImageIcon,
    title: 'Image Poll',
    description: 'Upload photos as options and let attendees vote for their favorite.',

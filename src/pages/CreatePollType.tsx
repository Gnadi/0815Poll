  ...
  return (
    <Layout title="Create New Poll" showBack>
      <div className="mb-6 lg:mb-8">
        <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 lg:text-2xl">Select your poll type</h2>
            ...
            >
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  <h3 className="font-bold text-gray-900 dark:text-gray-100 lg:text-lg">{pt.title}</h3>

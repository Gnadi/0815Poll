...
import { BarChart2, Calendar, MapPin, Sliders, GripVertical, CheckSquare, Users } from 'lucide-react'
...
const typeConfig = {
  ...
  multi_choice: { icon: CheckSquare, label: 'Multi-Choice', color: 'bg-cyan-100 text-cyan-700' },
}

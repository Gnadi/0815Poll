...
import { BarChart2, Calendar, MapPin, Sliders, GripVertical, Users, Target, Image } from 'lucide-react'
...
const typeConfig = {
  ...
  image: { icon: Image, label: 'Image Vote', color: 'bg-pink-100 text-pink-700 dark:bg-pink-900/40 dark:text-pink-400' },
}

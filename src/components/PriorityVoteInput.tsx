    ...
    <div className="space-y-3 mb-6">
      ...
      {!disabled && (
        <div className={`flex items-center justify-between rounded-xl px-4 py-2.5 text-sm font-semibold ${
          remaining === 0 ? 'bg-blue-500 text-white' : 'bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400'
        }`}>
              ...
              {disabled ? (
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <button
                    ...
                    className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 hover:border-blue-300 hover:text-blue-600 disabled:opacity-30 disabled:cursor-not-allowed transition-colors text-lg font-bold"

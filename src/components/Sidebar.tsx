...
import { BarChart2, Compass, PlusCircle, User, Settings, Moon, Sun } from 'lucide-react'
  ...
  return (
    <aside className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 lg:left-0 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 z-50">
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-100 dark:border-gray-700">
        ...
        <span className="text-lg font-bold text-gray-900 dark:text-gray-100">0815Poll</span>
      </div>
